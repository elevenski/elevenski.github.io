window.addEventListener('DOMContentLoaded', async function() {
    ...
    document.querySelectorAll('.github-card').forEach(async function(el) {
      ...
      <a href="${data.html_url}" target="_blank">
            <div class="github mt-2 p-3 rounded-lg">
                <div class="github-left">
                    <div class="github-title text-black">
                    <a style="color: gray !important">elevenvac/</a>${data.name || "RG EMİR"}
                    </div>
                    <div class="github-sdescription text-gray-600 mt-1">
                    ...
                    <div class="github-description text-gray-600 mt-1">
